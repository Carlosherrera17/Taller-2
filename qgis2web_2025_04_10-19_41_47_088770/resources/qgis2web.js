...
map.getView().fit([-8638187.500814, -1736181.951397, -8192988.286848, -1437321.352642], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">GEOLOGIA DEL DEPARTAMENTO DE ICA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (27 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '@Carlos David Herrera Barba';
            }
